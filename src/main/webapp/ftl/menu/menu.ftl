...
<div class="row" style="height: 60px;">
	<ul class="nav nav-pills">
		...
		<li role="" class="active">
			...
			<ul class="dropdown-menu">
				<li><a href="/ksb/user/list"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> 用户管理</a></li>
				<li><a href="/ksb/role/list"><span class="glyphicon glyphicon-align-center" aria-hidden="true"></span> 角色管理</a></li>
				<li><a href="/ksb/module/list"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> 模块管理</a></li>
			</ul>
		</li>
		<li role="">
			<a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
